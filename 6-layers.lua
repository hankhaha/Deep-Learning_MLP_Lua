...
-- Increase the number of nerons to 800 nurons
module = nn.Sequential()
module:add(nn.Convert('bchw', 'bf')) -- collapse 3D to 1D
module:add(nn.Linear(1*28*28, 2500)) --One layer
module:add(nn.Tanh())
module:add(nn.Linear(2500, 2000)) --Two layer
module:add(nn.Tanh())
module:add(nn.Linear(2000, 1500)) --Three layer
module:add(nn.Tanh())
module:add(nn.Linear(1500, 1000)) --Four layer
module:add(nn.Tanh())
module:add(nn.Linear(1000, 500)) --Five layer
module:add(nn.Tanh())
module:add(nn.Linear(500, 10))   -- Six layer
